...
3. Create an extended network. The architecture and layer of the extended network is automatically determined based on the baseline network by using the procedure discussed in the paper.
```sh
